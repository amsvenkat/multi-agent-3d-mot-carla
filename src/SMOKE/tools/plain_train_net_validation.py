...
from smoke.data import make_data_loader, build_val_loader
...
# changed for vlaidation
#from smoke.engine.trainer import do_train
#from smoke.engine.trainer_val import do_train
from smoke.engine.trainer_val_metrics import do_train
...
def train(cfg, model, device, distributed):
    ...
    print("Save to disk:", save_to_disk)
    ...
    ##extra_checkpoint_data.save("pretrained_ImageNet", **arguments)
    #print("Complete")
