...
def do_kitti_detection_evaluation(dataset,
    ...
    # Commneted out the following lines because they are not needed for our use case
    ...
    # label_dir = '/export/amsvenkat/project/ma_perception/SMOKE/datasets/kitti/training/label_2'
    ...
    # logger.info(output)
    # #os.chdir('../tools')
    # os.chdir('/export/amsvenkat/project/ma_perception/SMOKE/tools')
